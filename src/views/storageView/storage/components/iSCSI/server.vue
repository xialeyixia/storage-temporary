      ...
      >
        ...
        <el-table-column :label="$t('table.operate')">
          <template #default="scope">
            <el-button
              size="small"
              @click="removeNbdServer(scope.row)"
              type="primary"
      ...
      <template #footer>
        <span class="dialog-footer">
          ...
          <el-button
            type="primary"
            size="small"
            @click="sureAddNbdServer"
            :disabled="sureLoading || !serverForm.name"
            :loading="sureLoading"
...
export default {
  ...
  methods: {
    ...
    getNbdServerList() {
      ...
      this.$api
        .get(
          '/webapp/get_server_nbd?remote_ip=' + this.$route.query.ip,
          {},
          true,
        )
        .then((res) => {
    ...
    sureAddNbdServer() {
      ...
      this.$api
        .post(
          '/webapp/set_server_nbd?remote_ip=' + this.$route.query.ip,
          this.serverForm,
          true,
        )
        .then((res) => {
    ...
    removeNbdServer(row) {
      this.$messageBox
        ...
        .then(() => {
          ...
          this.$api
            .deletes(
              '/webapp/delete_server_nbd?remote_ip=' + this.$route.query.ip,
              row,
              true,
            )
            .then((res) => {
